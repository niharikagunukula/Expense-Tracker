...
public class pd_week_pie extends AppCompatActivity {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        try {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                pieChart.setCenterText("Weekly Expenses");
                            ...
                            e.printStackTrace();
                           // Toast.makeText(pd_week_pie.this,"Check your Internet connection",Toast.LENGTH_SHORT).show();
                        }
                    }
